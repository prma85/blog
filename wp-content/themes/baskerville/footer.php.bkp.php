...
<div class="credits section bg-dark small-padding">
	...
	<div class="credits-inner section-inner">
		...
		<p class="credits-left fleft">
			...
			&copy; <?php echo date("Y") ?> <a href="<?php echo home_url(); ?>" title="<?php bloginfo('name'); ?>"><?php bloginfo('name'); ?></a><span> &mdash; <?php printf( __( 'Criado com <a href="%s">WordPress</a>', 'baskerville'), 'http://www.wordpress.org' ); ?></span>
